...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// We only use the arg OtherComp, but we have to declare like this. Because the other params are decorations.\n// ??? check the book see design pattern delegation and decoration ???\n// OthercComp: the component we have to collect in the game, ie. the pickable item.\n// This means the function below is a delegate.\n" },
		{ "ModuleRelativePath", "BatteryMan.h" },
		{ "ToolTip", "We only use the arg OtherComp, but we have to declare like this. Because the other params are decorations.\n??? check the book see design pattern delegation and decoration ???\nOthercComp: the component we have to collect in the game, ie. the pickable item.\nThis means the function below is a delegate." },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABatteryMan_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABatteryMan_OnBeginOverlap, "OnBeginOverlap" }, // 2281019378
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABatteryMan_Statics::NewProp_CameraBoom_MetaData[] = {
		{ "Category", "Camera" },
		{ "Comment", "// The violet capital text means this is a macro.\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "BatteryMan.h" },
		{ "ToolTip", "The violet capital text means this is a macro." },
	};
#endif
	...
	IMPLEMENT_CLASS(ABatteryMan, 230831769);
